...
{
    [Authorize]
    public class OSUSurveysController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewData["Answers"] = db.OSUAnswers.ToList();
            ViewData["Settings"] = db.SettingSets.ToList();
            return View(db.OSUSurveys.OrderByDescending(x => x.CreatedDate).ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            OSUSurvey survey = db.OSUSurveys.Find(id);
            if (survey == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "SurveyID,CreatedDate,IdentityCode,SettingsID,PointTotal,ChoseToBetFlag")] OSUSurvey survey)
        {
            if (ModelState.IsValid)
            {
                db.OSUSurveys.Add(survey);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SurveyID,CreatedDate,IdentityCode,SettingsID,PointTotal,ChoseToBetFlag")] OSUSurvey survey)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult DeleteAllConfirmed()
        {
            ...
            foreach (OSUSurvey survey in db.OSUSurveys)
            {
                db.OSUSurveys.Remove(survey);
            }
            db.SaveChanges();
        ...
        public FileContentResult DownloadCSV()
        {
            ...
            List<OSUSurvey> surveyList = db.OSUSurveys.ToList();
            List<SettingSet> settingList = db.SettingSets.ToList();
            List<Race> raceList = db.Races.ToList();

            List<OSUAnswer> answerList = db.OSUAnswers.ToList();
            ...
            foreach (OSUSurvey survey in surveyList.OrderBy(x => x.SettingsID).ThenByDescending(x => x.CreatedDate))
            {
                ...
                List<OSUAnswer> answers = answerList.Where(x => x.SurveyID == survey.SurveyID).ToList();
                ...
                OSUAnswer hopeful1Ans = answers.Find(x => x.QuestionID == hopeful1.QuestionID);
                if (hopeful1Ans != null)
                {
                ...
                OSUAnswer worried1Ans = answers.Find(x => x.QuestionID == worried1.QuestionID);
                if (worried1Ans != null)
                {
                ...
                OSUAnswer happy1Ans = answers.Find(x => x.QuestionID == happy1.QuestionID);
                if (happy1Ans != null)
                {
                ...
                OSUAnswer sad1Ans = answers.Find(x => x.QuestionID == sad1.QuestionID);
                if (sad1Ans != null)
                {
                ...
                OSUAnswer relieved1Ans = answers.Find(x => x.QuestionID == relieved1.QuestionID);
                ...
                OSUAnswer disappointed1Ans = answers.Find(x => x.QuestionID == disappointed1.QuestionID);
                ...
                OSUAnswer amused1Ans = answers.Find(x => x.QuestionID == amused1.QuestionID);
                if (amused1Ans != null)
                {
                ...
                OSUAnswer angry1Ans = answers.Find(x => x.QuestionID == angry1.QuestionID);
                if (angry1Ans != null)
                {
                ...
                OSUAnswer contented1Ans = answers.Find(x => x.QuestionID == contented1.QuestionID);
                ...
                OSUAnswer disgusted1Ans = answers.Find(x => x.QuestionID == disgusted1.QuestionID);
                ...
                OSUAnswer hopeful2Ans = answers.Find(x => x.QuestionID == hopeful2.QuestionID);
                if (hopeful2Ans != null)
                {
                ...
                OSUAnswer worried2Ans = answers.Find(x => x.QuestionID == worried2.QuestionID);
                if (worried2Ans != null)
                {
                ...
                OSUAnswer happy2Ans = answers.Find(x => x.QuestionID == happy2.QuestionID);
                if (happy2Ans != null)
                {
                ...
                OSUAnswer sad2Ans = answers.Find(x => x.QuestionID == sad2.QuestionID);
                if (sad2Ans != null)
                {
                ...
                OSUAnswer relieved2Ans = answers.Find(x => x.QuestionID == relieved2.QuestionID);
                ...
                OSUAnswer disappointed2Ans = answers.Find(x => x.QuestionID == disappointed2.QuestionID);
                ...
                OSUAnswer amused2Ans = answers.Find(x => x.QuestionID == amused2.QuestionID);
                if (amused2Ans != null)
                {
                ...
                OSUAnswer angry2Ans = answers.Find(x => x.QuestionID == angry2.QuestionID);
                if (angry2Ans != null)
                {
                ...
                OSUAnswer contented2Ans = answers.Find(x => x.QuestionID == contented2.QuestionID);
                ...
                OSUAnswer disgusted2Ans = answers.Find(x => x.QuestionID == disgusted2.QuestionID);
                ...
                OSUAnswer entertainingAns = answers.Find(x => x.QuestionID == entertaining.QuestionID);
                ...
                OSUAnswer funToWatchAns = answers.Find(x => x.QuestionID == funToWatch.QuestionID);
                ...
                OSUAnswer watchingAns = answers.Find(x => x.QuestionID == watching.QuestionID);
                if (watchingAns != null)
                {
                ...
                OSUAnswer enjoyableAns = answers.Find(x => x.QuestionID == enjoyable.QuestionID);
                ...
                OSUAnswer questionOSU1Ans = answers.Find(x => x.QuestionID == questionOSU1.QuestionID);
                ...
                OSUAnswer questionOSU2Ans = answers.Find(x => x.QuestionID == questionOSU2.QuestionID);
                ...
                OSUAnswer questionOSU3Ans = answers.Find(x => x.QuestionID == questionOSU3.QuestionID);
                ...
                OSUAnswer questionOSU4Ans = answers.Find(x => x.QuestionID == questionOSU4.QuestionID);
                ...
                OSUAnswer questionUO1Ans = answers.Find(x => x.QuestionID == questionUO1.QuestionID);
                ...
                OSUAnswer questionUO2Ans = answers.Find(x => x.QuestionID == questionUO2.QuestionID);
                ...
                OSUAnswer questionUO3Ans = answers.Find(x => x.QuestionID == questionUO3.QuestionID);
                ...
                OSUAnswer questionUO4Ans = answers.Find(x => x.QuestionID == questionUO4.QuestionID);
                ...
                OSUAnswer questionExcitingAns = answers.Find(x => x.QuestionID == questionExciting.QuestionID);
                ...
                OSUAnswer questionInvolvedAns = answers.Find(x => x.QuestionID == questionInvolved.QuestionID);
